 ...
 */
public class FragmentAmerica extends Fragment{

    private View view;
    private RecyclerView rv_ame;
    private RecyclerViewAdapter recyclerViewAdapter;
    public static final int SHOW_SONG = 0;
    public static List<SongItem> data;
    public static int pos;
    public static Player player = FragmentHot.player;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case SHOW_SONG:
                    ...
                    rv_ame.setAdapter(recyclerViewAdapter);
    ...
    public FragmentAmerica(Handler handler_activity){
        super();
    ...
    private void init(){
        rv_ame = (RecyclerView) view.findViewById(R.id.recyclerview_song);
        rv_ame.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    private StringBuilder getSongdata(){
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    URL url = new URL("https://route.showapi.com/213-4?showapi_appid=19025&topid=3&showapi_sign=cb0d53bafc8045d5865d96ca67df23f0");
