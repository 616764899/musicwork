 ...
 */
public class FragmentTai extends Fragment{
    private View view;
    ...
    public FragmentTai(Handler handler_activity){
        super();
    ...
    private StringBuilder getSongdata(){
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    URL url = new URL("https://route.showapi.com/213-4?showapi_appid=19025&topid=6&showapi_sign=cb0d53bafc8045d5865d96ca67df23f0");
